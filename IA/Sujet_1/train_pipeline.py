...
def main():
    ...
    _name_map = {'Logistic Regression': 'logistic_regression', 'Random Forest': 'random_forest', 'XGBoost': 'xgboost', 'MLP': 'mlp', 'SVM': 'svm'}
    ...
    _rul_name_map = {'Régression Linéaire': 'logistic_regression', 'Random Forest': 'random_forest', 'XGBoost': 'xgboost', 'MLP': 'mlp', 'SVM': 'svm'}
